...
# Convenience getters
def get_users_collection(): return COLLECTIONS["users"]
def get_inventory_collection(): return COLLECTIONS["inventory"]
def get_warehouse_collection(): return COLLECTIONS["warehouse"]
def get_builderdistributors_collection(): return COLLECTIONS["builderdistributors"]
def get_transactions_collection(): return COLLECTIONS["transactions"]
def get_cashbooks_collection(): return COLLECTIONS["cashbooks"]
def get_transfers_collection(): return COLLECTIONS["transfers"]
...
def ensure_indexes():
    ...
    # Inventory, Warehouse, BuilderDistributors: unique name
    ...
    # Transactions and Cashbooks: index on date
    ...
    # Transfers: index on date
    get_transfers_collection().create_index([("date", ASCENDING)], name="idx_transfers_date")
